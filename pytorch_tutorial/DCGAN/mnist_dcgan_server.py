...
num_test_sampels = 5*5
fixed_noise = torch.randn(num_test_sampels, G_input_dim).view(-1, G_input_dim, 1, 1)
...
for epoch in range(num_epochs):
    ...
    for i, (images, _) in enumerate(data_loader):
        ...
        # Train discrimitator with real data
        D_real_decision = D(x_).squeeze()
        # print(D_real_decision, y_real_)
        D_real_loss = criterion(D_real_decision, y_real_)
        
        # Train discrimitator with fake data
